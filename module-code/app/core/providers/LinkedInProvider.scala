...
import reactivesecurity.core.{Oauth1ProviderMK2, ThisDoesNotBelongHere, OAuth1Provider, OAuth1Info}
...
class LinkedInProviderMK2[USER <: UsingID](f: ThisDoesNotBelongHere => USER) extends Oauth1ProviderMK2[USER] {
